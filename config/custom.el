...
(custom-set-variables
 ...
 '(custom-safe-themes
	 '("5604af9b6347ef57c1dda7abc0a2edfe19a2fc75a2d106006320eca39e1fce66"
 ...
 '(package-selected-packages
	 '(perspective-tabs eshell-syntax-highlighting kind-icon
											all-the-icons-completion nyan-mode
											eshell-git-prompt python-pytest paredit blackout
											nano-theme git-timemachine magit focus lsp-ui
											lox-mode prettier-js perspective typescript-mode
											tsx-mode modus-themes wgrep imenu-list
											side-hustle lsp-pyright python-black
											iceberg-theme web-mode corfu material-theme
											yafolding yasnippet-snippets use-package
											undo-tree tron-legacy-theme tree-sitter-langs
											sublime-themes sqlformat rg restclient rake
											rainbow-delimiters projectile pdf-view-restore
											origami org-roam-ui org-drill org-download
											org-bullets orderless olivetti native-complete
											multi-vterm marginalia kubel inflections
											inf-ruby helpful go-mode flycheck
											exec-path-from-shell evil-vimish-fold
											evil-leader evil-collection enh-ruby-mode
											embark-consult doom-themes doom-modeline docker
											dired-sidebar dashboard bug-hunter
											balanced-windows auctex all-the-icons-dired)))
;;; custom.el ends here
(custom-set-faces
